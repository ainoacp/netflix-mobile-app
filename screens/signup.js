        ...
        <SafeAreaView style={tw`bg-black flex-1`}>
            ...
            >
                <KeyboardAvoidingView 
                    ...
                    style={tw`flex-1`}
                >
                    <View style={tw`py-6 px-8 flex justify-center items-center`}>
                        <Logo width={90} />
                    </View>
                    <View style={tw`flex-1 items-center justify-center px-12`}>
                        ...
                        <Text
                            style={tw`text-red-500 self-start mb-6 ${(isValidPassword || password === '') && 'opacity-0'
                                }`}
                        >
                            Debe contener A-b-0-!
                        </Text>
                        <Pressable onPress={() => navigation.navigate('SignIn')} style={tw`mb-12`}>
                            <Text style={tw` text-white/40 text-xl`}>Registrate</Text>
                        </Pressable>
                        <View style={tw`flex flex-row items-center`}>
                            <Text style={tw`text-white`}>¿Ya tienes una cuenta? </Text>
                            <Pressable onPress={() => navigation.navigate('SignIn')}>
                                <Text style={tw`text-red-500 font-bold`}>Inicia sesión</Text>
                            </Pressable>
                        </View>
                    </View>
                </KeyboardAvoidingView>
